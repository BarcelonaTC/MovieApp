...
class MovieByKeywordDataSource @Inject constructor(private val service: MovieService) :
    BasePagingSource<MovieDto>() {

    private var mediaKeyword by Delegates.notNull<String>()
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieDto> {
        ...
        return try {
            val response = service.getDiscoverMovie(keywords = mediaKeyword, page = pageNumber)
            LoadResult.Page(
